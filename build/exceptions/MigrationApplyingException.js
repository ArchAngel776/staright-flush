...
let MigrationApplyingException = (0, _Except.default)(_class = /*#__PURE__*/function (_MigrationExecutorExc) {
  _inherits(MigrationApplyingException, _MigrationExecutorExc);

  function MigrationApplyingException() {
    return _MigrationExecutorExc.apply(this, arguments) || this;
  }

  _createClass(MigrationApplyingException, [{
    key: "getName",
  ...
  return MigrationApplyingException;
}(_MigrationExecutorException.default)) || _class;

exports.default = MigrationApplyingException;