...
let EmptyMigrationException = (0, _Except.default)(_class = /*#__PURE__*/function (_Exception) {
  _inherits(EmptyMigrationException, _Exception);

  function EmptyMigrationException() {
    return _Exception.apply(this, arguments) || this;
  }

  _createClass(EmptyMigrationException, [{
    key: "getName",
  ...
  return EmptyMigrationException;
}(_Exception2.default)) || _class;

exports.default = EmptyMigrationException;